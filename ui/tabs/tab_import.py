...
class Tab(ttk.Frame):
 ...
 def __init__(self,m):
  ...
  ttk.Label(L,text="Import — modular",font=("TkDefaultFont",10,"bold")).pack(anchor='w',padx=12,pady=12)
  R.grid_rowconfigure(0,weight=1); R.grid_columnconfigure(0,weight=1)
  grp=ttk.LabelFrame(R,text="Import CLI"); grp.grid(row=0,column=0,sticky='nsew',padx=8,pady=8)
